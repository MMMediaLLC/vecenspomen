...
export const CITIES: City[] = [
  ...
  { name: 'Прилеп', slug: 'prilep' },
  { name: 'Тетово', slug: 'tetovo' },
  { name: 'Велес', slug: 'veles' },
  { name: 'Штип', slug: 'stip' },
  { name: 'Охрид', slug: 'ohrid' },
  { name: 'Гостивар', slug: 'gostivar' },
  { name: 'Струмица', slug: 'strumica' },
  { name: 'Кавадарци', slug: 'kavadarci' },
  { name: 'Кочани', slug: 'kocani' },
  { name: 'Кичево', slug: 'kicevo' },
  { name: 'Струга', slug: 'struga' },
  { name: 'Радовиш', slug: 'radovis' },
  { name: 'Гевгелија', slug: 'gevgelija' },
  { name: 'Дебар', slug: 'debar' },
  { name: 'Крива Паланка', slug: 'kriva-palanka' },
  { name: 'Свети Николе', slug: 'sveti-nikole' },
  { name: 'Неготино', slug: 'negotino' },
  { name: 'Делчево', slug: 'delcevo' },
  { name: 'Виница', slug: 'vinica' },
  { name: 'Пробиштип', slug: 'probistip' },
  { name: 'Берово', slug: 'berovo' },
  { name: 'Кратово', slug: 'kratovo' },
  { name: 'Богданци', slug: 'bogdanci' },
  { name: 'Крушево', slug: 'krusevo' },
  { name: 'Македонска Каменица', slug: 'makedonska-kamenica' },
  { name: 'Валандово', slug: 'valandovo' },
  { name: 'Македонски Брод', slug: 'makedonski-brod' },
  { name: 'Демир Капија', slug: 'demir-kapija' },
  { name: 'Пехчево', slug: 'pehcevo' },
  { name: 'Демир Хисар', slug: 'demir-hisar' },
  { name: 'Друго место', slug: 'other' },
];
