      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        {style === 'orthodox' && (
          <div className="absolute inset-x-3 inset-y-3 md:inset-x-5 md:inset-y-5 border-2 border-stone-800 pointer-events-none">
             ...
             {/* Center Top Symbol */}
             <div className="absolute -top-[0.95rem] md:-top-[1.25rem] left-1/2 -translate-x-1/2 bg-white px-1.5 md:px-2">
               <span className="text-[1.6rem] md:text-3xl text-stone-800 block leading-none">☦</span>
             </div>
          </div>
        )}
