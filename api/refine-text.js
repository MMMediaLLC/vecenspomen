...
${isShort ? `
БИДЕЈЌИ ТЕКСТОТ Е КРАТОК — прошири го природно во 2 до 4 реченици кои произлегуваат од дадените зборови и контекстот на објавата. Не измислувај конкретни факти кои ги нема.
` : ''}
СТИЛ И ТОН:
...
- Не додавај имиња кои ги нема во оригиналниот текст

ФОРМАТ:
- Врати САМО финалниот текст, без воведи, објаснувања или коментари
- Должина: точно 2 до 4 реченици
- Зачувај ги сите факти од оригиналот точно
