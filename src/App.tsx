...
import { getPosts, addPost as firebaseAddPost, updatePostStatus as firebaseUpdateStatus, updatePost as firebaseUpdatePost, deleteGuestbookEntry as firebaseDeleteGuestbookEntry, deleteMemorialPost, updateGuestbookEntryStatus } from './lib/posts';
